    ...
    <div class="wrapper">
        ...
        <nav id="sidebar">
            <div class="sidebar-header">
                <h3><img src="img/logo.png" class="img-fluid" /><span>Sales</span></h3>
            </div>
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a class='btn btn-success' href='edit1.php?id=<?php echo $row['id'] ?>'>Edit</a>
                                                <a class='btn btn-danger' href='delete1.php?id=<?php echo $row['id'] ?>'>Delete</a>
                                            </td>
